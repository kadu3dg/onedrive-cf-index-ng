...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'kadurock15@hotmail.com',
  ...
  footer:
    'Powered by <a href="https://github.com/lyc8503/onedrive-cf-index-ng" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by Kadu.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/Private', '/Meus arquivos/ Imagens/ Capturas de tela'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'kadurock15@hotmail.com',
